...
public class PaginationServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        int start = (currentPage - 1) * numberOfProduct;
        int end = Math.min(start + numberOfProduct, productList.size());
        ...
        request.setAttribute("totalPages", (int) Math.ceil((double) productList.size() / numberOfProduct));
        request.setAttribute("listP", pageProducts);
        request.setAttribute("numberofp", numberOfProduct);
